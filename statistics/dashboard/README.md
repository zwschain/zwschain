## Go ZWS Chain Dashboard

The dashboard is a data visualizer integrated into gptn, intended to collect and visualize useful information of an ZWS Chain node. It consists of two parts:
